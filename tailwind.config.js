...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-sky': 'linear-gradient(135deg, #0ea5e9 0%, #1e3a8a 100%)',
        'gradient-sky-futuristic': 'linear-gradient(135deg, #0ea5e9 0%, #0369a1 30%, #1e3a8a 100%)',
      ...
      boxShadow: {
        ...
        'glow-futuristic': '0 0 40px rgba(30, 58, 138, 0.6)',
      },
      backdropBlur: {
        'modern': '12px',
        'ultra': '20px',
